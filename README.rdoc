...
Since there are guaranteed to be edge cases this has a straight-forward 
mechanism to develop plugins and drop them in a config directory and 
use them right along side the built in stuff.  Examples are created 
